...
public class ReservationTests {
    ...
    public void reservationCreationTest() {
        ...
        for (int i = 0; i < 1; i++) {
            reservationService.reserve(new Reservation(scheduledTrip.getScheduledTransitions().get(2), scheduledTrip.getScheduledTransitions().get(4), seatService.findEntityById(6L), new Passenger("Aanasrika", "Petrova", "Kartselska", 19 + 1, "10891734fzs237", "1an2d111ikas194311abv.bfg"), ReservationStatus.NEW, LocalDateTime.now()));
        }
    }
    @Test
