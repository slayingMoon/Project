package com.tsh.frantishex.eventService.event;
...
public class EventManager {
    private static final String BASE_PACKAGE = "com.tsh.frantishex";
    @Autowired
        ...
        if (eventHandlerMap.containsKey(event.getClass())) {
            eventHandlerMap.get(event.getClass()).forEach(eventHandler -> {
                try {
                    ...
                    eventHandler.invoke(declaringClass.getDeclaredConstructor().newInstance(), event);
