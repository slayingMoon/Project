...
import com.tsh.frantishex.reservationService.model.entity.ReservationCity;
...
import com.tsh.frantishex.reservationService.model.entity.Seat;
...
public class ScheduledTransitionServiceImpl extends GenericServiceImpl<ScheduledTransition> {
    ...
    public ScheduledTransition findTransitionByTrip(ScheduledTrip trip, ReservationCity transition) {
