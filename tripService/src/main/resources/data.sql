...
insert into city (name) values ('Ihtiman');
insert into city (name) values ('Kostenetz');
insert into city (name) values ('Belovo');
insert into city (name) values ('Pazardjik');
insert into city (name) values ('Plovdiv');
insert into city (name) values ('Stara Zagora');
insert into city (name) values ('Yambol');
